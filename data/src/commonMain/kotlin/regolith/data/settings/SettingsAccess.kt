 ...
 */
suspend fun <STORED, DATA> SettingsAccess.getData(setting: DataSetting<*, STORED, DATA>): DATA {
 ...
 */
suspend fun <STORED, DATA> SettingsAccess.writeData(setting: DataSetting<*, STORED, DATA>, value: DATA) {
 ...
 */
suspend fun <STORED, DATA> SettingsAccess.observeData(setting: DataSetting<*, STORED, DATA>): Flow<DATA> {
